...
// WSDL     : http://localhost:5886/wsdl/ICalculadora
// Version  : 1.0
// (03/02/2023 19:47:16 - - $Rev: 103843 $)
// ************************************************************************ //
...
type
  ...
  // URL       : http://localhost:5886/soap/ICalculadora
  // ************************************************************************ //
  ICalculadora = interface(IInvokable)
  ['{E66E1709-D4FD-53FF-B516-9DF0139B4A7B}']
    function  echoSomar(const aNum1: Double; const aNum2: Double): string; stdcall;
    function  echoSubtrair(const aNum1: Double; const aNum2: Double): string; stdcall;
    function  echoMultiplicar(const aNum1: Double; const aNum2: Double): string; stdcall;
    function  echoDividir(const aNum1: Double; const aNum2: Double): string; stdcall;
  end;
...
const
  defWSDL = 'http://localhost:5886/wsdl/ICalculadora';
  defURL  = 'http://localhost:5886/soap/ICalculadora';
