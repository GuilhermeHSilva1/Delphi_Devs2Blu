...
begin
  Self.PegarValores;
  lblResultado.Caption := 'Resultado: ' + GetICalculadora.echoDividir(xValor1, xValor2);
end;

procedure TForm2.btnMultiplicarClick(Sender: TObject);
begin
  Self.PegarValores;
  lblResultado.Caption := 'Resultado: ' + GetICalculadora.echoMultiplicar(xValor1, xValor2);
end;

procedure TForm2.btnSomarClick(Sender: TObject);
begin
  Self.PegarValores;
  lblResultado.Caption := 'Resultado: ' + GetICalculadora.echoSomar(xValor1, xValor2);
end;

procedure TForm2.btnSubtrairClick(Sender: TObject);
begin
  Self.PegarValores;
  lblResultado.Caption := 'Resultado: ' + GetICalculadora.echoSubtrair(xValor1, xValor2);
end;

procedure TForm2.PegarValores;
begin

  edtPrimeiroValor.Text := StringReplace(edtPrimeiroValor.Text, '.', ',', [rfReplaceAll, rfIgnoreCase]);
  edtSegundoValor.Text  := StringReplace(edtSegundoValor.Text, '.', ',', [rfReplaceAll, rfIgnoreCase]);
