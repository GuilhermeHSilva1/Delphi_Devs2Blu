...
begin
  ...
  THorse.Group.Prefix('v1')
    .Get('/unidademedidas', TControllerUnidadeMedida.GetProdutos)
    .Get('/unidademedida/:id', TControllerUnidadeMedida.GetProduto)
    .Post('/unidademedida', TControllerUnidadeMedida.PostProduto)
    .Delete('/unidademedida/:id', TControllerUnidadeMedida.DeleteProduto);
end;
