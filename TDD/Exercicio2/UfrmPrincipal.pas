...
begin
  ...
  label4.Caption := 'Preço Un. : ' + (FProduto.FPreco_Unitario).ToString;
...
begin
  ...
  FProduto.FPreco_Unitario := InputBox('Produto','Digite o preço unitario do Produto,', '').ToDouble;
...
begin
  try
    xDesconto := FProduto.VerificarDesconto(StrToInt(edtQuantidade.Text));
